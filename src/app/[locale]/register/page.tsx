          ...
          <section className="relative hidden min-h-[620px] flex-col justify-between bg-[#243126] p-8 text-white lg:flex">
            ...
            <div>
              ...
              <div className="mt-10 space-y-4">
                ...
                <h1 className="max-w-sm text-4xl font-semibold leading-tight">{t('registerTitle')}</h1>
                <p className="max-w-sm text-base leading-7 text-white/72">{t('registerSubtitle')}</p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="rounded-2xl border border-white/12 bg-white/[0.07] p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium">{t('registerPanelTitle')}</p>
                    <p className="mt-1 text-sm leading-6 text-white/68">{t('registerPanelText')}</p>
                  </div>
                </div>
              </div>
            ...
            <div className="mx-auto w-full max-w-md">
              ...
              <div className="mb-6 flex items-center justify-between gap-3 lg:hidden">
                <div>
                  ...
                  <h1 className="mt-2 text-3xl font-semibold leading-tight">{t('registerTitle')}</h1>
                </div>
